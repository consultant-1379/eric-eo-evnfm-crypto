...
import com.ericsson.eo.evnfm.crypto.exceptions.UnknownKeyException;
...
public class PostKeysNegativeBase {
    @Mock
    ...
    @BeforeEach
    public void setUp() {
        willThrow(UnknownKeyException.class).given(keyService).updateLatestCipherKey();
