...
public class SecurityConfigReader {
     ...
     */
    @VisibleForTesting
    String hideSensitiveConstants(String message, String sensitiveConstantsJson) {
    ...
    private static String decryptJson(byte[] encryptedJson, byte[] initialVector, byte[] encryptionKey) {
