...
import org.openapitools.api.DecryptionApi;
...
public class DecryptionController implements DecryptionApi {
    ...
    @Override
    public ResponseEntity<DecryptionResponse> decryptionPost(
            String accept,
            String contentType,
            @RequestBody(required = false) DecryptionPostRequest decryptionRequest) {

        return new ResponseEntity<>(cryptoService.decrypt(decryptionRequest), HttpStatus.OK);
    }
}
